...
def evaluate_search_results(labels_path: str, k_values: List[int] = [1, 3, 5, 10]) -> Dict:
    """
    ...
    summary = {
        ...
        'relevance_rate': sum(sum(r) for r in per_query_relevant) / sum(len(r) for r in per_query_relevant)
    }
